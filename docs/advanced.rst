...
If the default exception conversion described :ref:`above <catching_and_throwing_exceptions>`
is not sufficient, the additional header file :file:`pybind11/exception_translator.h` provides
...
as demonstrated in :file:`example19.cpp``.
